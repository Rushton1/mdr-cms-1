...
var transport = nodemailer.createTransport("SMTP", {
	...
	auth: {
		user: 'homepagecontactform@rushtonmd.com', // this needs to be changed to the real value on the server
		pass: '9_5?uJlV*+p?' // this needs to be changed to the real value on the server
	}
});
